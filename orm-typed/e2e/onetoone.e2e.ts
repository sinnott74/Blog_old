import { BaseModel, Entity, Column, OneToOne, metadata } from "../dist/orm";
...
describe("Basic Entity interaction", () => {
  ...
  it("creates a blogpost then adds the owner and saves it", async () => {
    const person = new Person({ firstname: "Joe", lastname: "Bloggs" });
    await person.save();
...
// yarn build && ../node_modules/jest/bin/jest.js onetoone.e2e.ts
